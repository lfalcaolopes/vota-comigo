...
- Cada **Deputado** no **Comparativo de deputados** tem sua própria **Janela do comparativo**; as métricas de proposições assinadas, órgãos e cota são calculadas sobre a janela inteira, com as contagens absolutas normalizadas por ano efetivo e a cota como posição sobre o período.
