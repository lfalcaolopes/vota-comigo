...
O banco armazena os inputs de cálculo da fórmula de relevância (contagens do placar, código de tipo de proposição, curadoria de apelido popular quando ela for modelada, e demais sinais ingeridos) e nunca o score final. O score é calculado em runtime ou em job derivado, a partir dos inputs persistidos.
