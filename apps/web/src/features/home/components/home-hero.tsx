...
export function HomeHero() {
  return (
    <section className="border-b border-border">
      <div className="mx-auto grid w-full min-w-0 max-w-5xl gap-8 px-4 pt-12 pb-12 md:pt-20 md:pb-16">
        <div className="grid max-w-[36ch] gap-5">
          ...
          <p className="max-w-[58ch] text-lg leading-normal text-pretty text-muted">
            ...
            deputados federais nas votações da Câmara. Sem recomendação de voto,
            com fonte oficial e método aberto.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
          ...
          <ButtonLink className="sm:w-auto" href="/proposicoes" variant="secondary">
            Ver proposições
          </ButtonLink>
        </div>
