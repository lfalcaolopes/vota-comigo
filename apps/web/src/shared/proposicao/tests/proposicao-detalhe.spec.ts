...
describe("ProposicaoDetalhe", () => {
  ...
  describe("resumo de proposicao por IA", () => {
    ...
    it("capitalizes the first character of each detailed bullet", () => {
      // Arrange
      const proposicao = makeProposicao({
        resumoIaDisponivel: true,
        resumoIaCard: "Resumo curto aprovado.",
      ...
      // Assert
      expect(html).toContain("<li>Altera a regra de aposentadoria.</li>");
      expect(html).toContain("<li>Reduz o teto de gastos.</li>");
    });
