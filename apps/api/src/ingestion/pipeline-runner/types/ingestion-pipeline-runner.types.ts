...
export type IngestionPipelineRunnerConfigResolution =
  | {
      ok: true;
...
export type IngestionPipelineRunnerConfigOptions = {
  currentYear?: number;
...
export type CsvRowSource = () => AsyncIterable<
  import('../sources/csv-reader').CsvRow
>;
...
export type IngestionPipelineRunnerResult =
  | {
      ok: true;
      config: IngestionPipelineRunnerConfig;
...
export type IngestionPipelineRunnerExecutionResult =
  | {
      ok: true;
      exitCode: 0 | 1;
